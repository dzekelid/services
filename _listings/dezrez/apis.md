...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/services/master/_listings/dezrez/apis.md
...
- name: Dezrez.Rezi.Client.Api - check if the user has setup their credientials for
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/services/master/_listings/dezrez/apisyncmailsendenabled-get-openapi.md
- name: Dezrez.Rezi.Client.Api - check if the user has setup their credientials for
    smtp services
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/services/master/_listings/dezrez/apisyncimapserversetup-get-openapi.md
x-common:
- type: x-github
